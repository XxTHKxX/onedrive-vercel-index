...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'xxthkxx@adobevn.com',
  ...
  title: "ThoSky 239 Phan Mem",

  // The folder that you are to share publicly with onedrive-vercel-index. Use '/' if you want to share your root folder.
  baseDirectory: '/ThoSky',
  ...
  email: 'mailto:xxthkxx@adobevn.com',
